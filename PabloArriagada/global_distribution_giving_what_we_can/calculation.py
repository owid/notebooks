...
df_ppp_factors = df_ppp_factors.rename(columns={'Country Name': 'country', 'Country Code': 'country_code', '2017': 'ppp_2017'})
...
df_cpi = df_cpi[(df_cpi['year'] == 2017) | (df_cpi['year'] == MAX_YEAR_CPI)].reset_index(drop=True)
...
df_ppp = df_ppp_factors.merge(df_cpi[["country_code", "cpi_2017", f"cpi_{MAX_YEAR_CPI}", "inflation_rate"]], on='country_code', how='left')
