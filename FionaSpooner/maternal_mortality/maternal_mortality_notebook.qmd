...
ggplot(data = df_fin %>% filter(entity== "Sweden"), aes(x = year, y = as.numeric(maternal_mortality_rate), group = entity, colour = entity))+
  geom_line()+
  theme_bw()+
  labs(x = "Year", y = "Maternal Mortality Rate", title = "Maternal Mortality Rate")
```
...
ggplot(data = df_wide, aes(x = year, y = relative_change_mmr, group = entity))+
geom_line(alpha = 0.2)+
  labs(x = "Year", y = "Relative change since 2000", title = "Relative change in maternal mortality rate since 2000")+
  theme_bw()+
