...
**JH comment**: Not quite sure what's not working in the following plot.
...
```{python}
#Pablo: This is my version of the previous code. Please delete the other if I understood correctly
#The graph is shown and there are no slice warnings
...
fig = px.scatter(df_plot,
                 ...
                 y = 'Main data',
                 log_x = False,
                 log_y = True, #False will show the weird Bermuda values and not too much detail
                 color = 'entity',
                 facet_col = 'measure',
                 opacity=0.5)
fig.show()
