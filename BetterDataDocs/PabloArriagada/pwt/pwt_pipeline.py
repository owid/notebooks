...
# %%
# Print the metadata
md("**Name:**  {}".format(datasetName))
# %%
md("**Source:**  {}".format(datasetSourceName))
# %%
md("**Link:**  {}".format(datasetLink))
# %%
md("**Description:**  {}".format(datasetDescription))
# %%
md("**Last updated:**  {}".format(datasetRetrieved))
# %%
md("**Expected data of next update:**  {}".format(datasetNextUpdateExpected))
...
variableUnitShorts = []
variableDescription = []
#This last one is the name we will use for this variable within this pipeline
variableNames = []
...
# %% [markdown]
"""
*Joe will write here an explanation of the different approaches to prices that define the different GDP variables.*
#
Joe's notes: 
#
