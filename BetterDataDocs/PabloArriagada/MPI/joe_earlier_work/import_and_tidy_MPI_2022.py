...
df = pd.read_csv('Original/GMPI2022_publicuse.csv')
...
country_names_map = pd.read_csv("Manipulation/countries 2022_standardized.csv")
...
# %%
# # Examples of countries with four Year observations
n_Years.loc[n_Years.unique_Years>3].head()
...
# %%
# Write to csv
df_main_hot.to_csv("final/MPI (2022) – Harmonized over time estimates.csv", index=False)
...
# %%
# Write to csv
df_main_cme.to_csv("final/MPI (2022) – Current estimates.csv", index=False)
