...
# %% 
raw_csv_url="https://joeh.fra1.digitaloceanspaces.com/wid/gini_and_topshares.csv"
entity_mapping_url= "https://joeh.fra1.digitaloceanspaces.com/wid/WID_regions_country_standardized.csv"
mapping_varname_raw = 'WID code'
mapping_vaname_owid = "Our World In Data Name"
data_varname_old='country'
data_varname_new='entity'
s3_space_to_save_in='wid'
as_filename='gini_and_topshares_standardized.csv'
...
df_mapping = pd.read_csv(entity_mapping_url, keep_default_na=False,
                            na_values=['']) 

df_mapping = df_mapping[[mapping_varname_raw, mapping_vaname_owid]]
# %% 
...
# %%
upload_to_s3(df_harmonized,
            "wid",
            "gini_and_topshares_standardized.csv")