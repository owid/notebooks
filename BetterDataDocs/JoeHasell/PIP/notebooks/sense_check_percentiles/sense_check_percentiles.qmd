...
Dropping El Salvador and Sierra Leone (for negative poverty lines) and any headcount=0 observations.

```{python}
#| code-fold: true
#| code-summary: 'Drop Suriname and Sierra Leone and describe p10 results'

df[~df['entity'].isin(['El Salvador', 'Sierra Leone'])].describe()
...
The negative poverty lines come from two countries: Sierra Leone and El Salvador
```{python}
#| code-fold: true
#| code-summary: ''


df[df['threshold']<0]['entity'].drop_duplicates().tolist
