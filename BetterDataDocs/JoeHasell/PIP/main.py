...
# %%
print('CAUTION: If a full update is needed, first you have to run relative poverty percentile extraction codes')
...
# %%
df_final, col_relative = integrate_relative_poverty(df_final, df_country, ppp=ppp_version, answer)
