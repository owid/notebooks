...
egen nonmissing_values = rownonmiss(country_name year regime_row_owid regime_redux_row_owid regime_amb_row_owid electmulpar_row electmulpar_high_row electmulpar_low_row electmulpar_leg_row electmulpar_leg_high_row electmulpar_leg_low_row electmulpar_hoe_row_owid electmulpar_hoe_high_row_owid electmulpar_hoe_low_row_owid electfreefair_row electfreefair_high_row electfreefair_low_row electdem_dich_row_owid electdem_dich_high_row_owid electdem_dich_low_row_owid accessjust_m_row accessjust_m_high_row accessjust_m_low_row accessjust_w_row accessjust_w_high_row accessjust_w_low_row transplaws_row transplaws_high_row transplaws_low_row lib_dich_row lib_dich_high_row lib_dich_low_row ///
	...
	lib_vdem lib_vdem_low lib_vdem_high indiv_libs_vdem indiv_libs_vdem_low indiv_libs_vdem_high judicial_constr_vdem judicial_constr_vdem_low judicial_constr_vdem_high legis_constr_vdem legis_constr_vdem_low legis_constr_vdem_high ///
	...
	civ_libs_vdem civ_libs_vdem_high civ_libs_vdem_low phys_integr_libs_vdem phys_integr_libs_vdem_high phys_integr_libs_vdem_low pol_libs_vdem pol_libs_vdem_high pol_libs_vdem_low priv_libs_vdem priv_libs_vdem_high priv_libs_vdem_low ///
	wom_emp_vdem wom_emp_vdem_high wom_emp_vdem_low wom_civ_libs_vdem wom_civ_libs_vdem_high wom_civ_libs_vdem_low wom_civ_soc_vdem wom_civ_soc_vdem_high wom_civ_soc_vdem_low wom_pol_par_vdem wom_pol_par_vdem_high wom_pol_par_vdem_low wom_parl_vdem wom_hos_vdem wom_hog_vdem wom_hoe_vdem ///
	socgr_civ_libs_vdem socgr_civ_libs_vdem_high socgr_civ_libs_vdem_low socgr_pow_vdem socgr_pow_vdem_high socgr_pow_vdem_low ///
	terr_contr_vdem terr_contr_vdem_high terr_contr_vdem_low rule_of_law_vdem rule_of_law_vdem_high rule_of_law_vdem_low public_admin_vdem public_admin_vdem_high public_admin_vdem_low int_auton_vdem int_auton_vdem_high int_auton_vdem_low dom_auton_vdem dom_auton_vdem_high dom_auton_vdem_low ///
	corruption_vdem corruption_vdem_high corruption_vdem_low corr_publsec_vdem corr_publsec_vdem_high corr_publsec_vdem_low corr_exec_vdem corr_exec_vdem_high corr_exec_vdem_low corr_leg_vdem corr_leg_vdem_high corr_leg_vdem_low corr_jud_vdem corr_jud_vdem_high corr_jud_vdem_low corruption_cpi ///
	personalism_vdem personalism_vdem_high personalism_vdem_low civ_soc_str_vdem civ_soc_str_vdem_high civ_soc_str_vdem_low ///
...
drop nonmissing_values empty_observation regime_row_owid regime_redux_row_owid regime_amb_row_owid electmulpar_row electmulpar_high_row electmulpar_low_row electmulpar_leg_row electmulpar_leg_high_row electmulpar_leg_low_row electmulpar_hoe_row_owid electmulpar_hoe_h_row_owid electmulpar_hoe_l_row_owid electfreefair_row electfreefair_high_row electfreefair_low_row electdem_dich_row_owid electdem_dich_high_row_owid electdem_dich_low_row_owid accessjust_m_row accessjust_m_high_row accessjust_m_low_row accessjust_w_row accessjust_w_high_row accessjust_w_low_row transplaws_row transplaws_high_row transplaws_low_row lib_dich_row lib_dich_high_row lib_dich_low_row ///
	...
	lib_vdem lib_vdem_low lib_vdem_high indiv_libs_vdem indiv_libs_vdem_low indiv_libs_vdem_high judicial_constr_vdem judicial_constr_vdem_low judicial_constr_vdem_high legis_constr_vdem legis_constr_vdem_low legis_constr_vdem_high ///
	particip_vdem particip_vdem_low particip_vdem_high civsoc_particip_vdem civsoc_particip_vdem_low civsoc_particip_vdem_high dirpop_vote_vdem locelect_vdem locelect_vdem_low locelect_vdem_high regelect_vdem regelect_vdem_low regelect_vdem_high ///
	delib_vdem delib_vdem_low delib_vdem_high justified_polch_vdem justified_polch_vdem_low justified_polch_vdem_high justcomgd_polch_vdem justcomgd_polch_vdem_low justcomgd_polch_vdem_high counterarg_polch_vdem counterarg_polch_vdem_low counterarg_polch_vdem_high elitecons_polch_vdem elitecons_polch_vdem_low elitecons_polch_vdem_high soccons_polch_vdem soccons_polch_vdem_low soccons_polch_vdem_high turnout_vdem ///
	egal_vdem egal_vdem_low egal_vdem_high equal_rights_vdem equal_rights_vdem_low equal_rights_vdem_high equal_access_vdem equal_access_vdem_low equal_access_vdem_high equal_res_vdem equal_res_vdem_low equal_res_vdem_high ///
	civ_libs_vdem civ_libs_vdem_high civ_libs_vdem_low phys_integr_libs_vdem phys_integr_libs_vdem_high phys_integr_libs_vdem_low pol_libs_vdem pol_libs_vdem_high pol_libs_vdem_low priv_libs_vdem priv_libs_vdem_high priv_libs_vdem_low ///
	wom_emp_vdem wom_emp_vdem_high wom_emp_vdem_low wom_civ_libs_vdem wom_civ_libs_vdem_high wom_civ_libs_vdem_low wom_civ_soc_vdem wom_civ_soc_vdem_high wom_civ_soc_vdem_low wom_pol_par_vdem wom_pol_par_vdem_high wom_pol_par_vdem_low wom_parl_vdem wom_hos_vdem wom_hog_vdem wom_hoe_vdem ///
	socgr_civ_libs_vdem socgr_civ_libs_vdem_high socgr_civ_libs_vdem_low socgr_pow_vdem socgr_pow_vdem_high socgr_pow_vdem_low ///
