...
* Import data:
use "democracy/datasets/refined/lied_refined.dta", clear
...
use "democracy/datasets/refined/lied_refined.dta"
merge 1:1 country_name year using "democracy/datasets/final/lied_aggregated.dta"
drop _merge
merge 1:1 country_name year using "democracy/datasets/final/lied_aggregated_popweighted.dta"
drop _merge
merge 1:1 country_name year using "democracy/datasets/final/lied_aggregated_regions.dta"
drop _merge
merge 1:1 country_name year using "democracy/datasets/final/lied_aggregated_popweighted_regions.dta", update
drop _merge
erase "democracy/datasets/final/lied_aggregated.dta"
erase "democracy/datasets/final/lied_aggregated_popweighted.dta"
erase "democracy/datasets/final/lied_aggregated_regions.dta"
erase "democracy/datasets/final/lied_aggregated_popweighted_regions.dta"
...
** Export data:
save "democracy/datasets/final/lied_final.dta", replace
export delimited "democracy/datasets/final/lied_final.csv", replace nolabel

describe, replace
keep name varlab
rename name varname
rename varlab varlabel
export delimited "democracy/datasets/final/lied_final_meta.csv", replace
