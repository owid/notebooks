...
import excel "Lexical Index of Electoral Democracy v6.5/LIED_6.5.xlsx", firstrow clear
...
replace regime_redux_lied = "6" if regime_lied == 7 // Coding error for Argentina in 2022.
destring regime_redux_lied, replace
...
** Export datasets:
save "democracy/datasets/cleaned/lexical_cleaned.dta", replace
export delimited "democracy/datasets/cleaned/lexical_cleaned.csv", replace nolabel
