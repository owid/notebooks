...
# calculate numbers in poverty between pov lines for stacked area
 headcount_stacked_calcs<- df %>%
  filter(grepl("headcount_",new_varnames) & !grepl("ratio",new_varnames) & !grepl("multi",new_varnames) & !grepl("median",new_varnames)) %>%
...
explorer_var_sets[["poverty"]]<- c(explorer_var_sets[["poverty"]],
                                   "headcount_ratio_stacked_above_40_00",
                                   "headcount_stacked_above_40_00")
