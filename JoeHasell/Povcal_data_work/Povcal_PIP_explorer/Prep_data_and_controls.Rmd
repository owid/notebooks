...
global_controls<- list()
  
global_controls[["explorerTitle"]]<- "Poverty explorer"
global_controls[["selection"]]<- c("India", "Mozambique")
global_controls[["isPublished"]]<- "'false"
global_controls[["googleSheet"]]<- "https://docs.google.com/spreadsheets/d/1-65yg7odNc6wym6VxXc5Sj0Dt0A9QPaL8mfzUhc1yHE/edit#gid=1080881077"
global_controls[["hasMapTab"]]<- "'true"


tables<- data.frame(
  table = c(
    "inc_or_cons_extrap",
    "inc_or_cons_no_extrap",
    "inc_extrap",
    "inc_no_extrap",
    "cons_extrap",
    "cons_no_extrap"
...
tables_fp<- "https://raw.githubusercontent.com/owid/notebooks/main/JoeHasell/Povcal_data_work/Povcal_PIP_explorer/data/poverty/"

tables$links<- paste0(tables_fp,tables$table, ".csv")
