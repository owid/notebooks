...
for(explorer in explorers){
  ...
  df_by_survey_type<- list()
    ...
    df_by_survey_type[["inc"]]<- df_explorer %>%
    ...
    df_by_survey_type[["cons"]]<- df_explorer %>%
    ...
    df_by_survey_type[["inc_or_cons"]]<- df_explorer
...
#   filename<- "inc.csv"
#     fp<- paste0("data/", names(explorer_var_sets)[i], "/", filename)
#     write.csv(filter_by_survey, fp, row.names = FALSE)
# 
#     # Income only, excluding extrapolated years
#     filter_by_survey<- df_explorer %>%
#       filter(IsSurveyYear == TRUE,
#              datatype == "income")
# 
#     filename<- "inc_no_extrap.csv"
#     fp<- paste0("data/", names(explorer_var_sets)[i], "/", filename)
#     write.csv(filter_by_survey, fp, row.names = FALSE)
# 
#     # Consumption only, including extrapolated years
