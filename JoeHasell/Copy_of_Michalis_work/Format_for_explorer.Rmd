...
xlsxFile <- "https://raw.githubusercontent.com/owid/notebooks/main/JoeHasell/Copy_of_Michalis_work/control_stubs.xlsx"

head(read.xlsx(xlsxFile))

test<- openxlsx::read.xlsx(url, sheet = "control_stubs")

tab <- readxl::read_excel(loadWorkbook_url(url), sheet = "control_stubs")
...
aux_list[["abs_povline_currency"]]<- c(
  "1",
  "1.90",
  "3.20",
  "5.50")
